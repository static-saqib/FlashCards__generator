    ...
    <div>
      ...
      <Formik initialValues={{
        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
            <div className='bg-customRed p-7 my-2 drop-shadow-md rounded-lg'>
              <div className="flex flex-wrap">
                <div className=" w-96 px-3">
                  ...
                  <Field className="appearance-none w-full my-2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="Create_Group"
                    name='Create_Group'
                    type="text"
                ...
                <div>
                  ...
                  {
                    values.uploadimage ? (<div className='flex '> <img className='h-16 mt-2' src={values.uploadimage} alt="" /> 
                     <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue("uploadimage", '')} /> </div>) :
            ...
            <FieldArray
              name="term"
              render={(arrayHelpers) => (
                <div className='bg-customRed p-7 my-4 drop-shadow-md rounded-lg'>
